...
namespace SubDb
{
    public class SubDbSubtitleProvider : ISubtitleProvider, IHasOrder
    {
        ...
        public SubDbSubtitleProvider(ILogger logger, IHttpClient httpClient, IFileSystem fileSystem, IApplicationHost appHost)
        {
            _logger = logger;
